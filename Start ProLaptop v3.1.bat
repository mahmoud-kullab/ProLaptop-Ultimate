@echo off
title Pro Laptop Ultimate v3.1 - Launcher
color 0A
...
:: ============================================================
if not exist "%~dp0ProLaptop Ultimate v3.1.ps1" (
    echo.
    echo  [!] ERROR: ProLaptop_Ultimate_v3.1.ps1 not found!
...
set "SCRIPT=%~dp0ProLaptop Ultimate v3.1.ps1"
